...
from kappadata.compat.image import resized_crop, get_image_size
...
class KDRandomResizedCrop(KDStochasticTransform):
    def __init__(
        ...
        self.interpolation = resolve_interpolation(interpolation)
    ...
    def get_params(self, img):
        # same as the Paddle random resized crop but with rng
        width, height = get_image_size(img)
        area = height * width

        # the original implementation has a floating point error which is bad for testing
