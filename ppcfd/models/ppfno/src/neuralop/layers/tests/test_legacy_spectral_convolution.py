...
from ..legacy_spectral_convolution import SpectralConv
from ..legacy_spectral_convolution import SpectralConv1d
from ..legacy_spectral_convolution import SpectralConv2d
from ..legacy_spectral_convolution import SpectralConv3d
