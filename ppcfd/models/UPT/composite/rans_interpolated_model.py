...
class RansInterpolatedModel(CompositeModelBase):
    def __init__(self, latent, decoder, grid_resolution=None, **kwargs):
        ...
        grid_resolution = (
            grid_resolution or self.data_container.get_dataset().grid_resolution
        )
    ...
    @property
    def submodels(self):
        return dict(latent=self.latent, decoder=self.decoder)
