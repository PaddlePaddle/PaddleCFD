...
class PathProvider:
    ...
    def stage_output_path(self) -> Path:
        return self.get_stage_output_path(
    ...
    def stage_output_path_exists(self) -> bool:
        return self.get_stage_output_path(
            stage_name=self.stage_name, stage_id=self.stage_id, mkdir=False
        ).exists()
    ...
    def get_primitive_output_path(self, stage_name: str, stage_id: str) -> Path:
        stage_output_path = self.get_stage_output_path(
    ...
    def primitive_output_path(self) -> Path:
        return self.get_primitive_output_path(
            stage_name=self.stage_name, stage_id=self.stage_id
        )

    def get_primitive_config_uri(self, stage_name: str, stage_id: str) -> Path:
        return (
            self.get_primitive_output_path(stage_name=stage_name, stage_id=stage_id)
            / "config.yaml"
        )

    @property
    def primitive_config_uri(self) -> Path:
        return self.get_primitive_config_uri(
            stage_name=self.stage_name, stage_id=self.stage_id
        )
    ...
    def primitive_entries_uri(self) -> Path:
        return self.get_primitive_entries_uri(
            stage_name=self.stage_name, stage_id=self.stage_id
        )
    ...
    def primitive_summary_uri(self) -> Path:
        return self.get_primitive_summary_uri(
            stage_name=self.stage_name, stage_id=self.stage_id
        )

    def get_stage_checkpoint_path(self, stage_name: str, stage_id: str):
        return self._mkdir(
            self.get_stage_output_path(stage_name=stage_name, stage_id=stage_id)
            / "checkpoints"
        )

    @property
    def checkpoint_path(self):
        return self.get_stage_checkpoint_path(
            stage_name=self.stage_name, stage_id=self.stage_id
        )
