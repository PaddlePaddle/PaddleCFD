...
from distributed.config import get_nodes, get_world_size, is_rank0
from providers.config_providers.noop_config_provider import NoopConfigProvider
from providers.config_providers.primitive_config_provider import \
    PrimitiveConfigProvider
from providers.config_providers.wandb_config_provider import \
    WandbConfigProvider
from providers.path_provider import PathProvider
from providers.summary_providers.noop_summary_provider import \
    NoopSummaryProvider
from providers.summary_providers.primitive_summary_provider import \
    PrimitiveSummaryProvider
from providers.summary_providers.wandb_summary_provider import \
...
def init_wandb(
    ...
    if str(device) == "cpu":
        ...
        # Fallback to CPU label when CUDA is requested but unavailable at runtime.
        if paddle.is_compiled_with_cuda() and paddle.device.cuda.device_count() > 0:
            additional_config["device"] = paddle.device.cuda.get_device_name(0)
        else:
            additional_config["device"] = "cpu"
