...
class RansGinoEncdecSdfTrainer(SgdTrainer):
    ...
    def input_shape(self):
        ...
        assert isinstance(
            collator.collator, RansGinoEncdecSdfCollator,
        )
    ...
    class Model(paddle.nn.Layer):
        ...
        def prepare(self, batch):
            ...
            return dict(
                ...
                mesh_to_grid_edges=self.to_device(
                    item="mesh_to_grid_edges", batch=batch
                ),
                grid_to_query_edges=self.to_device(
                    item="grid_to_query_edges", batch=batch
                ),
