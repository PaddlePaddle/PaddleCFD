...
class DeepONet(nn.Layer):
    def __init__(self, branch1_in, branch1_hidden, branch2_in, branch2_hidden, trunk_in, trunk_hidden, **kargs):
        super().__init__()
    ...
    def forward(self, inputs):
        ...
        y = paddle.mean(b1_out * b2_out * t_out, axis=1, keepdim=True)
        return y
